            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(searchString.Trim()))
                {
                    query = "select [ProgramSemesterSubjectID] [ID], [ProgramID], [Program], ProgSemID, ProgSemName [Semester], ProfSubID, SemSubTitle [Subject], Capacity, IsSubjectActive [Status]" +
                            "from v_AllSemesterSubjects where [ProgramSemesterIsActive] = 1 and [ProgramIsActive] = 1 and [SemesterIsActive] = 1 and [subjectIsActive] = 1 order by ProgSemID";
                }
                else
                {
                    query = "select [ProgramSemesterSubjectID] [ID], [ProgramID], [Program], ProgSemID, ProgSemName [Semester], ProfSubID, SemSubTitle [Subject], Capacity, IsSubjectActive [Status]" +
                            "from v_AllSemesterSubjects where [ProgramSemesterIsActive] = 1 and [ProgramIsActive] = 1 and [SemesterIsActive] = 1 and [subjectIsActive] = 1" +
