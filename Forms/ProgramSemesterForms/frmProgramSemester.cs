    ...
    public partial class frmProgramSemester : Form
    {
        ...
        public void FillGrid(string searchString)
        {
            try
            {
                ...
                {
                    query = "select ProgSemID [ID], Program, Capacity, ProgramSemesterIsActive [Status], ProgramID, SemesterID from v_ProgramSemesterActiveList";
                }
                else
                {
                    query = "select ProgSemID [ID], Program, Capacity, ProgramSemesterIsActive [Status], ProgramID, SemesterID from v_ProgramSemesterActiveList where ProgSemName like '%" + searchString.Trim() + "%'";
                }
